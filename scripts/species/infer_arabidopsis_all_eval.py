...
"""
读取 finetune_all_eval_csv/arabidopsis_thaliana_all_eval.csv，保留原表所有列并追加微调模型生成结果。
"""
...
DEFAULT_INPUT_CSV = DATA_DIR / "finetune_all_eval_csv" / "arabidopsis_thaliana_all_eval.csv"
DEFAULT_OUTPUT_CSV = RESULTS_DIR / "arabidopsis_thaliana_all_eval_with_my_finetune.csv"
...
def parse_args():
    parser = argparse.ArgumentParser(description="Run Arabidopsis fine-tuned inference on all-eval CSV")
    ...
    parser.add_argument("--input_csv", default=str(DEFAULT_INPUT_CSV), help="Input all-eval CSV")
